(function(global) {
    function setupAsync(e) {
        ym.env = e;
        for (var t = 0, n = ym.envCallbacks.length; t < n; t++)
            ym.envCallbacks[t](e);
        ym.modules.define('system.nextTick', [], function(e) {
            var t = (function() {
                ...
                if (global.postMessage && !global.opera) {
                    ...
                    if (global.attachEvent) {
                        ...
                        global.attachEvent('onmessage', o),
                            global.postMessage('__checkAsync', '*'),
                            global.detachEvent('onmessage', o);
                    }
                    if (r) {
                        var i = '__ym' + +new Date(),
                            s = function(e) {
                        ...
                        return (
                            global.addEventListener
                                ? global.addEventListener('message', s, !0)
                                : global.attachEvent('onmessage', s),
                            function(e) {
            ...
            ym.modules.define('util.extend', ['util.objectKeys'], function(
                e,
                t
            ) {
                function n(e) {
                    if (ym.env.debug && !e)
                        throw new Error(
                            'util.extend: не передан параметр target'
                        );
                ...
                function r(e) {
                    ...
                    for (var n = 1, r = arguments.length; n < r; n++) {
                        var o = arguments[n];
                        if (o)
                            for (var i = t(o), s = 0, a = i.length; s < a; s++)
                                e[i[s]] = o[i[s]];
                    }
                    return e;
                }
            ...
            ym.modules.define('system.mergeImports', [], function(e) {
                function t(e, t, n) {
                    if (t) {
                        var r = e;
                        t = t.split('.');
                        for (var o, i = 0, s = t.length - 1; i < s; i++)
                            t[i] && (r = r[(o = t[i])] || (r[o] = {}));
                ...
                function o() {
                    ...
                    return (
                        ...
                        u.all([n(), r, c]).spread(function(n, r) {
                            a(r) && n.joinImports('package.ymaps', ym.ns, t, r),
                                e.onLoad &&
                                    ym.modules.nextTick(function() {
                                        i(0, e.onLoad, ym.ns);
                                    });
            ...
            ym.modules.define(
                'system.ModuleLoader',
                [
                    'system.moduleLoader.createLoadFunction',
                ...
                function(e, t, n, r) {
                    function o(e, n) {
                        (this._map = e),
                            (this._modulesInfo = this._parseMap(e)),
                            (this._waitForNextTick = !1),
                            (this._load = t(n, this._modulesInfo.byName));
                    }
                    var i = {
                    ...
                    (o.prototype.defineAll = function() {
                        for (var e = 0, t = this._map.length; e < t; e++) {
                            var n = this._map[e][0];
                            ym.modules.isDefined(n) ||
                                ym.modules.define(this.buildDefinition(n));
                        }
                    }),
                        (o.prototype.buildDefinition = function(e) {
                            ...
                            return (
                                n.key &&
                                    ...
                                    (o.storage = n.storage)),
                                n.dynamicDepends &&
                                    (o.dynamicDepends = n.dynamicDepends),
                                o
                            );
                        }),
                        (o.prototype._parseMap = function(e) {
                            for (
                                var t = { byName: {}, byAlias: {} },
                                    n = 0,
                                    r = e.length;
                                n < r;
                                n++
                        ...
                        (o.prototype._fetchDeps = function(e, t) {
                            if ('function' == typeof t)
                                return t.call({ name: e }, ym);
                            for (var n = []; t.length; ) {
                                var r = '';
                                '=' == t.charAt(0)
                                    ? ((r = t.match(/=(.+?)=/)[1]),
                                      n.push(r),
                                      (t = t.substring(r.length + 2)))
                                    : ((r = t.substring(0, 2)),
                                      n.push(this._modulesInfo.byAlias[r].name),
                                      (t = t.substring(2)));
                            }
                            return n;
                        }),
                        ...
                        (o.prototype._loadAll = function() {
                            for (var e = 0, t = this._map.length; e < t; ++e) {
                                ...
                                r.state == i.NOT_RESOLVED &&
                                    ym.modules.getState(n) == i.IN_RESOLVING &&
                                    ((r.state = i.IN_RESOLVING), this._load(n));
                            }
                            this._waitForNextTick = !1;
                        }),
                        e(o);
                    ...
                    (o.prototype.requireSync = function(e) {
                        ...
                        (o.prototype.require = function(e, t, n, r) {
                            return 3 == arguments.length &&
                                'function' != typeof n
                                ? ym.modules.require(e, t, n)
                                : ym.modules.require(e, t, n, r);
                        }),
                        ...
                        (o.prototype.execute = function() {
                            (this._executed = !0),
                                this._holdingFn &&
                                    this._holdingFn.apply(
                                        this._context,
                                        this._arguments
                                    );
                        }),
                        (o.prototype.providePackage =
                    ...
                    function n(e, n) {
                        ...
                        function s(t, n, o, s) {
                            ...
                            m &&
                                (m.mode &&
                                    (p +=
                                        '&mode=' + encodeURIComponent(m.mode)),
                                m.namespace &&
                                    (p +=
                                        '&namespace=' +
                                        encodeURIComponent(m.namespace))),
                                (d.charset = 'utf-8'),
                                (d.async = !0),
                                (d.src = p),
                        ...
                        function u(e) {
                            ...
                            p++;
                            var i =
                                ym.project.namespace +
                                ym.project.jsonpPrefix +
                                '_loader';
                            1 == e.length && (i += h[e[0]].moduleName),
                                a(o, i, ym.env.debug ? t : n, r);
                        }
                        function c() {
                            ...
                            if (r) {
                                for (
                                    f = f.sort(function(e, t) {
                                        return e.moduleName.localeCompare(
                                            t.moduleName
                                        );
                                    }),
                                        o = 0;
    ...
    !(function() {
            ...
            var r,
                ...
                i = function() {
                    var e = {
                        ...
                        j = function(t, r, i) {
                            if (t.state === o.RESOLVED)
                                return void i(t.exports);
                            if (t.state === o.IN_RESOLVING)
                                return void (e.trackCircularDependencies &&
                                f(t, r)
                                    ? i(null, u(t, r))
                                    : t.dependents.push(i));
                            if (
                                (t.dependents.push(i),
                                t.prev && !e.allowMultipleDeclarations)
                            )
                                return void D(t, l(t));
                            e.trackCircularDependencies &&
                                (r = r.slice()).push(t);
                            var s = !1,
                                a = t.prev ? t.deps.concat([t.prev]) : t.deps;
                            (t.state = o.IN_RESOLVING),
                                k(t, a, r, function(e, r) {
                                    return r
                                        ? void D(t, r)
                                        : (e.unshift(function(e, n) {
                                              return s
                                                  ? void i(null, c(t))
                                                  : ((s = !0),
                                                    void (n
                        ...
                        D = function(e, t) {
                            ...
                            for (var n, r = 0; (n = e.dependents[r++]); )
                                n(null, t);
                            e.dependents = [];
                        };
                    return {
                ...
                a = function(e, t) {
                    return Error(
                        t
                            ? 'Module "' +
                                  t.name +
                                  '": can\'t resolve dependence "' +
                                  e +
                                  '"'
                            : 'Required module "' + e + '" can\'t be resolved'
                    );
                },
                u = function(e, t) {
                    ...
                    return (
                        r.push(e.name),
                        Error(
                            'Circular dependence has been detected: "' +
                                r.join(' -> ') +
                                '"'
                        )
                    );
                ...
                l = function(e) {
                    return Error(
                        'Multiple declarations of module "' +
                            e.name +
                            '" have been detected'
                    );
                },
                ...
                d = (function() {
                    ...
                    if (n.postMessage && !n.opera) {
                        ...
                        if (n.attachEvent) {
                            ...
                            n.attachEvent('onmessage', i),
                                n.postMessage('__checkAsync', '*'),
                                n.detachEvent('onmessage', i);
                        }
                        if (o) {
                            ...
                            return (
                                n.addEventListener
                                    ? n.addEventListener('message', a, !0)
        ...
        (function() {
            ...
            !(function(r) {
                    ...
                    i = (function() {
                        ...
                        if (r.postMessage) {
                            ...
                            if (r.attachEvent) {
                                ...
                                r.attachEvent('onmessage', i),
                                    r.postMessage('__checkAsync', '*'),
                                    r.detachEvent('onmessage', i);
                            }
                            if (o) {
                                ...
                                return (
                                    r.addEventListener
                                        ? r.addEventListener('message', a, !0)
                                        : r.attachEvent('onmessage', a),
                                    function(e) {
                                        t(e) && r.postMessage(s, '*');
                                    }
                                );
                        ...
                        if ('onreadystatechange' in u.createElement('script')) {
                            var c = function() {
                                ...
                                (e.onreadystatechange = function() {
                                    ...
                                    (u.documentElement || u.body).appendChild(
                                        e
                                    );
                            };
                            return function(e) {
                ...
                var y = { PENDING: 0, RESOLVED: 1, FULFILLED: 2, REJECTED: 3 },
                    g = function(e) {
                        if (
                            ((this._value = o),
                ...
                g.prototype = {
                        ...
                        if (!(this._status > y.RESOLVED)) {
                            if (e === this)
                                return void this._reject(
                                    TypeError(
                                        "Can't resolve promise with itself"
                                    )
                                );
                            if (((this._status = y.RESOLVED), e && e._vow))
                    ...
                    _fulfill: function(e) {
                        this._status > y.RESOLVED ||
                            ((this._status = y.FULFILLED),
                            (this._value = e),
                            this._callCallbacks(this._fulfilledCallbacks, e),
                            (this._fulfilledCallbacks = this._rejectedCallbacks = this._progressCallbacks = o));
                    },
                    _reject: function(e) {
                        this._status > y.RESOLVED ||
                            ((this._status = y.REJECTED),
                            (this._value = e),
                    ...
                    _addCallbacks: function(e, t, n, r, i) {
                        ...
                        var s;
                        this.isRejected() ||
                            ((s = { defer: e, fn: u(t) ? t : o, ctx: i }),
                            this.isFulfilled()
                                ? this._callCallbacks([s], this._value)
                                : this._fulfilledCallbacks.push(s)),
                            this.isFulfilled() ||
                                ((s = { defer: e, fn: n, ctx: i }),
                                this.isRejected()
                                    ? this._callCallbacks([s], this._value)
                                    : this._rejectedCallbacks.push(s)),
                            this._status <= y.RESOLVED &&
                ...
                var w = {
                        ...
                        invoke: function(e, t) {
                            var n,
                                o,
                                i = Math.max(arguments.length - 1, 0);
                            if (i) {
                                n = Array(i);
                        ...
                        allResolved: function(e) {
                            ...
                            return (
                                w._forEach(e, s, s, t.notify, t, r), t.promise()
                            );
                        },
                        ...
                        _forEach: function(e, t, n, r, o, i) {
                            for (
                                var s = i ? i.length : e.length, a = 0;
                                a < s;

                            )
                                w.when(e[i ? i[a] : a], h(t, a), n, r, o), ++a;
                        },
    ...
    !(function(e, t, n) {
        ...
        var i,
            ...
            p = function(e) {
                return new Error(
                    'Undefined module `' + e + '` with no matching fallback.'
                );
            };
        (i = {
            fallbacks: new o(),
            define: function(e, n, r, o) {
                ...
                if (
                    (l.hasOwnProperty(e) || (l[e] = { name: e }),
                    'function' == typeof n && (n = n.call({ name: e }, ym)),
                    (l[e].callback = r),
                    (l[e].context = o),
                    s && a)
                ) {
                    if ('string' != typeof a)
                        for (var d = 0, p = a.length; d < p; d++)
                            this._createKeyStorageRef(e, a[d], s);
                ...
                if (null != n) {
                    for (var h = [], d = 0, p = n.length; d < p; d++)
                        h[d] = this._processModuleName(n[d]);
                    (h = this.fallbacks.addRetrievers(h)),
            ...
            require: function(r, o, s, c, l) {
                var f = a.defer(),
                    d = f.promise(),
                    p = n;
                if (3 == arguments.length && 'function' != typeof s)
                    (c = s), (s = null);
                    ...
                    (r = m.modules),
                        ...
                        (s = m.errorCallback),
                        (c = m.context),
                        m.hasOwnProperty('data') && (p = m.data);
                }
                r =
                    'string' != typeof r && r.hasOwnProperty('length')
                        ? r
                        : [r];
                var h = r.length,
                ...
                return (
                    (r = v.list),
                    ym.env.debug && !l && this.watchResolving(r),
                    v.error
                        ? f.reject(v.error)
                        : t.require(
                              r,
            ...
            defineSync: function(e, t) {
                ...
                r &&
                    ...
                    ((l[e].key = r),
                    (l[e].storage = n),
                    this._createKeyStorageRef(e, r, n));
            },
            requireSync: function(e, t) {
                var n = this.getDefinition(e),
                    r = null;
                return (
                    n && (r = n.getModuleSync.apply(n, u.call(arguments, 1))), r
                );
            },
            ...
            getDefinition: function(e) {
                var t = null;
                return (
                    (e = this._processModuleName(e)),
                    l.hasOwnProperty(e) && (t = new r(l[e])),
                    t
                );
            },
            getState: function(e) {
            ...
            watchResolving: function(e) {
                if (
                    ...
                    var t = this;
                    'undefined' == typeof this._failCounter &&
                        (this._failCounter = 0),
                        setTimeout(function() {
                            0 == t._failCounter &&
                                setTimeout(function() {
                            ...
                            for (var n = 0, r = e.length; n < r; n++)
                                if ('RESOLVED' != t.getState(e[n])) {
                                    if ((t._failCounter++, 5 == t._failCounter))
                                        setTimeout(function() {
                                            console.warn(
                                                'Timeout: Totally ' +
                                                    t._failCounter +
                                                    ' modules were required but not resolved within ' +
                                                    s +
                                                    ' sec.'
                                            );
                                        }, 100);
            ...
            _createPatchedCallback: function(e) {
                ...
                return function() {
                    var n = l[e],
                        ...
                        o = n.callback,
                        s = n.context;
                    ym.env.debug && t.watchResolving([e]),
                        (r[0] = i._patchProvideFunction(r[0], e)),
                        o && o.apply(s || this, r);
                };
            },
            _processModuleList: function(e, n, r) {
                for (var o = { list: [] }, i = 0, s = e.length; i < s; i++) {
                    ...
                    if ('undefined' != typeof n) {
                        ...
                        this.fallbacks.isRetriever(a) &&
                            this.fallbacks.addRetrieverData(a, n);
                    }
                    r || o.list.push(a);
                }
                return o;
            ...
            _patchProvideFunction: function(e, t) {
                var r = function(n, r) {
                    ...
                    (o.module = n),
                        e(n, r),
                        r || (delete o.callback, delete o.context);
                };
                return (
                    (r.provide = r),
                    (r.dynamicDepends = {
                        getValue: function(e, n) {
                            ...
                            if (
                                o.dynamicDepends &&
                                o.dynamicDepends.hasOwnProperty(e)
                            ) {
                                var s = o.dynamicDepends[e](n);
                                r.resolve(
                                    i._isDepend(s)
                                        ? i.getDefinition(s).getModule(n)
                                        : [s]
                                );
                            } else r.reject(d(e));
                            return r.promise();
                        ...
                        getValueSync: function(e, r) {
                            ...
                            if (
                                s.dynamicDepends &&
                                s.dynamicDepends.hasOwnProperty(e)
                            ) {
                                var a = s.dynamicDepends[e](r);
                                o = i._isDepend(a)
                                    ? i.getDefinition(a).getModuleSync(r)
                                    : a;
                            }
                            return o;
                        },
            ...
            (r.prototype.getModuleSync = function(e) {
                if (arguments.length > 0) {
                    ...
                    for (var r in t) {
                        ...
                        if (
                            i._isDepend(o) &&
                            !i.getDefinition(o).getModuleSync(e)
                        )
                            return n;
                    }
                }
        ...
        (o.prototype.register = function(e, t) {
            e && '*' != e
                ? this._fallbacks.unshift({ filter: e, func: t })
                : this._fallbacks.push({ filter: e || '*', func: t });
        }),
            ...
            (o.prototype.find = function(e) {
                for (var t = 0, n = this._fallbacks.length; t < n; t++) {
                    ...
                    if ('function' == typeof r && r(e))
                        return this._fallbacks[t];
                    if (e.match(r)) return this._fallbacks[t];
                }
                return null;
            }),
            (o.prototype.addRetrievers = function(e) {
                for (var t, n, r = [], o = 0, s = e.length; o < s; o++)
                    (t = e[o]),
                        i.isDefined(t)
                            ? r.push(t)
                            : ((n = m + t),
                              r.push(n),
                              i.isDefined(n) || this._defineRetriever(n));
                return r;
            }),
            (o.prototype.removeRetrievers = function(e) {
                for (var t, n = 0, r = e.length; n < r; n++)
                    this.isRetriever(e[n]) &&
                        !this._retrieversData[e[n]] &&
                        ((t = e[n].replace(m, '')),
                        i.isDefined(t) && (e[n] = t));
            }),
            ...
            (o.prototype.addRetrieverData = function(e, t) {
                this._retrieversData[e] || (this._retrieversData[e] = []),
                    this._retrieversData[e].push(t);
            }),
            ...
            (o.prototype._requireAfterRetrieve = function(e) {
                ...
                for (var n = [], r = 0, o = t.length; r < o; r++)
                    n.push(i.require({ modules: [e], data: t[r] }));
        ...
        (function(e) {
            ...
            ym.modules.define('util.id', [], function(e) {
                        ...
                        stringify: function(e, n, r, o) {
                            ...
                            for (i in e)
                                if (e.hasOwnProperty(i))
                                    if (((s = e[i]), t(s)))
                                        if (o.joinArrays)
                                            u.push(a(i) + r + a(s.join(',')));
                                        else
                                            for (var c = 0; c < s.length; ++c)
                                                'undefined' != typeof s[c] &&
                                                    u.push(a(i) + r + a(s[c]));
                                    else
                                        'undefined' != typeof s &&
                                            u.push(a(i) + r + a(s));
                ...
                ym.modules.define(
                    'util.jsonp',
                    ['util.id', 'util.querystring', 'util.script'],
                    function(e, t, n, r) {
                        function o(e) {
                        ...
                        function i(e) {
                            var o,
                                i,
                                a =
                                    'undefined' == typeof e.checkResponse ||
                                    e.checkResponse,
                                f = e.responseFieldName || 'response',
                                d = e.requestParams
                                    ? '&' +
                                      n.stringify(e.requestParams, null, null, {
                                          joinArrays: !0,
                                      })
                                    : '',
                                p = ym.vow.defer(),
                            ...
                            if (!e.padding) {
                                if (
                                    ((o = e.paddingKey || t.prefix() + t.gen()),
                                    'function' == typeof window[o] &&
                                        window[o].promise)
                                )
                                    return window[o].promise;
                                u(o),
                                    (window[o] = function(e) {
                                        if (a) {
                                            var t =
                            ...
                            var g =
                                ...
                                d;
                            if (e.postprocessUrl)
                                if ('function' == typeof e.postprocessUrl)
                                    g = e.postprocessUrl(g);
                                else
                                    for (; e.postprocessUrl.length; )
                        ...
                        var c = { message: 'timeoutExceeded' },
                            l = { message: 'scriptError' },
                            f = function() {},
                            d = {};
                        e(o);
                    }
        ...
        (function(e) {
            ...
            ym.project.namespace &&
                ('function' == typeof setupAsync
                    ? ym.envCallbacks.push(function(n) {
                          n.namespace !== !1 &&
                              t(e, n.namespace || ym.project.namespace, ym.ns);
                      })
                    : t(e, ym.project.namespace, ym.ns));
        })(this),
        ym.envCallbacks.push(function(e) {
            e.enterprise &&
                ym.project.preload.push('package.private.yandex.enterprise');
        }),
        ym.envCallbacks.push(function(e) {
        ...
        (function() {
            function e(t) {
                for (var n in t)
                    t.hasOwnProperty(n) &&
                        ('string' == typeof t[n]
                            ? '/' == t[n].charAt(0) && (t[n] = 'https:' + t[n])
                            : e(t[n]));
            }
            ym.envCallbacks.push(function(t) {
                '/' == t.server.url.charAt(0) &&
                    (t.server.url = 'https:' + t.server.url),
                    e(t.hosts);
            });
        })(),
        (ym.ns.load = function(e, t, n, r) {
            ...
            return 'function' == typeof e
                ? t
                    ? o(['package.full'], e, t)
                    : o(['package.full'], e)
                : ('string' == typeof e && (e = [e]), o.apply(this, arguments));
        }),
        ym.modules.define(
            'system.browser',
            ['system.supports.graphics'],
            function(e, t) {
                var n = ym.env.browser;
                (n.documentMode = document.documentMode),
                    (n.isIE = 'MSIE' == n.name || 'IEMobile' == n.name),
                    (n.oldIE = 'MSIE' == n.name && n.documentMode < 9),
                    (n.isEdge = 'Edge' == n.engine),
                    (n.isChromium =
                        n.base && 'chromium' == n.base.toLocaleLowerCase()),
                    (n.isSafari = 'Safari' == n.name);
                var r =
                    'Edge' == n.engine ||
                    ('MSIE' == n.name &&
                        n.documentMode >= 10 &&
                        n.osVersion > 6.1) ||
                    ('IEMobile' == n.name && n.engineVersion >= 6);
                r
                    ? (n.eventMapper = 'pointer')
                    : n.oldIE
                    ? (n.eventMapper = 'oldIE')
                    : (n.eventMapper = 'touchMouse'),
                    (n.androidBrokenBuild =
                        'AndroidBrowser' == n.name &&
                        '534.30' == n.engineVersion);
                var o =
                    window.devicePixelRatio ||
                    (screen.deviceXDPI && screen.deviceXDPI / 96) ||
                    1;
                n.oldIE
                    ? (n.graphicsRenderEngine = 'vml')
                    : !t.hasCanvas() ||
                      'MSIE' == n.name ||
                      'IEMobile' == n.name ||
                      ('Android' == n.osFamily &&
                          n.engine &&
                          'gecko' == n.engine.toLocaleLowerCase()) ||
                      (o > 1 && o < 2)
                    ? (n.graphicsRenderEngine = 'svg')
                    : (n.graphicsRenderEngine = 'canvas'),
                    (n.transformTransition =
                        'Android' == n.osFamily ||
                        'iOS' == n.osFamily ||
                        ('MSIE' == n.name && n.documentMode >= 10) ||
                        (n.base && 'chromium' == n.base.toLocaleLowerCase())),
                    (n.css3DTransform =
                        ('WebKit' == n.engine &&
                            !(
                                'Android' == n.osFamily &&
                                parseFloat(n.osVersion) < 3
                            )) ||
                        ('Gecko' == n.engine &&
                            parseInt(n.engineVersion.split('.')[0]) >= 10)),
                    (n.unsupported = 'OperaMini' == n.name),
                    (n.platform = n.isMobile ? n.osFamily : 'Desktop'),
                    e(n);
            }
        ),
        ym.modules.require(['system.browser']),
        ym.modules.require(['system.logger'], function(e) {
            ym.logger = e;
        }),
        ...
        (function(e) {
            ym.modules.define('system.supports.csp', [], function(e) {
                ...
                ym.modules.define('system.supports.graphics', [], function(e) {
                    function t() {
                        ...
                        var e = ym.env.browser,
                            t = { 'Samsung Internet': !0, AndroidBrowser: !0 },
                    ...
                    function r(e, t) {
                        (e.width = 226),
                            (e.height = 256),
                            (t.fillStyle = '#fff'),
                            t.fillRect(0, 0, 150, 150),
                            (t.globalCompositeOperation = 'xor'),
                            (t.fillStyle = '#f00'),
                            t.fillRect(10, 10, 100, 100),
                            (t.fillStyle = '#0f0'),
                            t.fillRect(50, 50, 100, 100);
                        for (
                            var n = t.getImageData(49, 49, 2, 2), r = [], o = 0;
                            o < 16;
                            o++
                        )
                            r.push(n.data[o]);
                        return (
                            '0x0x0x0x0x0x0x0x0x0x0x0x0x255x0x255' == r.join('x')
                        );
                    }
                    ...
                    e({
                        ...
                        hasVml: function() {
                            if (!('vml' in i)) {
                                ...
                                (n.innerHTML =
                                    '<v:shape id="yamaps_testVML"  adj="1" />'),
                                    (e = n.firstChild),
                                    e &&
                                        e.style &&
                                        ((e.style.behavior =
                                            'url(#default#VML)'),
                                        (t = !e || 'object' == typeof e.adj),
                                        n.removeChild(e)),
                                    (i.vml = t);
                            }
                            return i.vml;
                ...
                ym.modules.require(
                    ...
                    function(e, t, n) {
                        ym.env.server.params.csp &&
                            !n.isSupported &&
                            console &&
                            console.warn('CSP is not suported in this browser'),
                            (ym.supports = {
                                css: e,
                                graphics: t,
                                printPatchNeeded: !e.checkProperty(
                                    'printColorAdjust'
                                ),
                                csp: n,
                            });
    ...
    setupAsync({
        ...
        hosts: {
            api: {
                ...
                services: {
                    ...
                    panoramaLocate:
                        'https://api-maps.yandex.ru/services/panoramas/',
            ...
            layers: {
                ...
                stv:
                    'https://0%d.srdr.maps.yandex.net/?l=stv&%c&v=%v&%l&action=render',
                sta: 'https://lrs.maps.yandex.net/tiles?l=sta&%c&tm=%v&%l',
                staHotspot:
                    'https://lrs.maps.yandex.net/tiles?l=stj&%c&tm=%v&%l',
        ...
        layers: {
            ...
            trf: { version: '1513240828', scaled: true },
            sta: {
        ...
        geolocation: {
            ...
            span: { longitude: 0.154806, latitude: 0.102799 },
        },
        token: '12a19b385ff0220a1b6750b8338a557f',
        sign: (function(r) {
            function t(e) {
                if (n[e]) return n[e].exports;
                var o = (n[e] = { exports: {}, id: e, loaded: !1 });
                return (
                    r[e].call(o.exports, o, o.exports, t),
                    (o.loaded = !0),
                    o.exports
                );
            }
                ...
                function e() {
                    for (
                        var r = [
                            ...
                            t = [
                                [
                                    DOMException.SECURITY_ERR + 14,
                                    SVGAngle.SVG_ANGLETYPE_GRAD + 16,
                                ],
                                [
                                    ...
                                    (function() {
                                        ...
                                        return (
                                            (e.innerHTML = '<i wccv/>'),
                                            e.children[0].attributes[0].nodeType
                                        );
                                    })() + 9,
                                ],
                                [
                                    XMLHttpRequest.OPENED + 13,
                                    DOMException.INVALID_STATE_ERR - 4,
                                ],
                            ],
                            n = 0;
                        n < t.length;
            ...
            function(r, t) {
                ...
                r.exports = function(r) {
                    ...
                    return (
                        r.substring(0, n) + o.sort().join('&') + r.substring(e)
                    );
                };
            },
        ]),
